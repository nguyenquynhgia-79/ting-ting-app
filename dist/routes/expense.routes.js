...
router.post("/", (0, validate_middleware_1.validateRequest)(expense_validation_1.createExpenseSchema), expenseController.createExpense);
router.get("/", expenseController.getUserExpenses);
router.get("/group/:groupId", expenseController.getGroupExpenses);
router.patch("/:id", (0, validate_middleware_1.validateRequest)(expense_validation_1.updateExpenseSchema), expenseController.updateExpense);
